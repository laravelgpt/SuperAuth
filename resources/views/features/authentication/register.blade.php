    ...
    <div class="max-w-md w-full space-y-8">
        ...
        <div class="text-center">
            ...
            <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">
                Join SuperAuth and get started with secure authentication.
            </p>
        </div>

        <!-- Registration Form -->
        <div class="bg-white dark:bg-gray-800 py-8 px-6 shadow-xl rounded-xl border border-gray-200 dark:border-gray-700">
            <form class="space-y-6" action="{{ route('superauth.register') }}" method="POST">
                @csrf
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input 
                            ...
                            required 
                            value="{{ old('name') }}"
                            class="block w-full pl-10 pr-3 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent dark:bg-gray-700 dark:text-white transition duration-200 @error('name') border-red-500 @enderror"
                ...
                <div class="flex items-center">
                    ...
                    <label for="terms" class="ml-2 block text-sm text-gray-900 dark:text-gray-300">
                        I agree to the 
                        <a href="#" class="text-purple-600 dark:text-purple-400 hover:text-purple-500 dark:hover:text-purple-300 transition duration-200">
                            Terms and Conditions
                        </a>
                        and 
                        <a href="#" class="text-purple-600 dark:text-purple-400 hover:text-purple-500 dark:hover:text-purple-300 transition duration-200">
                ...
                <div class="mt-6">
                    ...
                    <div class="mt-6 grid grid-cols-2 gap-3">
                        <a href="{{ route('superauth.social.redirect', 'google') }}" class="w-full inline-flex justify-center py-2 px-4 border border-gray-300 dark:border-gray-600 rounded-lg shadow-sm bg-white dark:bg-gray-700 text-sm font-medium text-gray-500 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-600 transition duration-200">
                        ...
                        <a href="{{ route('superauth.social.redirect', 'github') }}" class="w-full inline-flex justify-center py-2 px-4 border border-gray-300 dark:border-gray-600 rounded-lg shadow-sm bg-white dark:bg-gray-700 text-sm font-medium text-gray-500 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-600 transition duration-200">
        ...
        <div class="text-center">
            <p class="text-sm text-gray-600 dark:text-gray-400">
                ...
                <a href="{{ route('superauth.login') }}" class="font-medium text-purple-600 dark:text-purple-400 hover:text-purple-500 dark:hover:text-purple-300 transition duration-200">
                    Sign in here
                </a>
            </p>
        </div>
